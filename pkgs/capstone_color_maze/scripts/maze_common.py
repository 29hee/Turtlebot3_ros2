...
COLOR_RANGES = {
    ...
    # ★ 주황색 장애물 배제: 주황은 H≈10~25 로 빨강 바로 옆이라 상단 경계가 넓으면 RED 로
    #   오인식된다. 상단 H 를 8→5 로, 하단(분홍/마젠타 쪽)을 172→174 로 좁혀 '순수 빨강만' 통과.
    #   (S/V 가 아니라 Hue 가 주황↔빨강 구분의 핵심.) 빨강 패널이 안 잡히면 5→7 로 살짝 넓힐 것.
    'RED':   [((0,   170, 90),  (5,   255, 255)),
             ((174, 170, 90),  (179, 255, 255))],
